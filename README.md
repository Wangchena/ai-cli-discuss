...
**AI-CLI-Discuss** 是一个创新的多CLI编排系统。你只需在 Web 界面中像聊天一样描述任务，系统会自动启动多个 AI CLI 实例（Claude、Gemini、Qoder 等），让它们像团队讨论一样：
...
└── cli/               # CLI 入口（cli-discuss + ai-cli-link 向下兼容）
```
